...
const AddPostContent = ({setShowImageViewer, showImageViewer}) => {
  return (
    <div className='flex justify-between items-center px-2 py-3 border border-line_color rounded-md'>
        ...
        <div className='flex items-center gap-x-8'>
            <div className={`cursor-pointer w-8 h-8 rounded-full hover:bg-gray-200 flex justify-center items-center transition-all ease-linear duration-100 ${showImageViewer && 'bg-gray-400'}`}
